 ...
 */
export const JUNK_SELECTORS: readonly string[] = [
  // standard noise
  "script",
  "style",
  "noscript",
...
export function applyJunkSelectors(doc: Document): void {
 ...
 */
export function normalizeDom(doc: Document): void {
 ...
 */
export function pickContentRoot(doc: Document): ContentRoot {
  ...
  const idContent =
    doc.querySelector("#content") ?? doc.querySelector(".content");
